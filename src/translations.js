export const translations = {
  th: {
    ...
    'about.feature.share':'แชร์ได้หลายช่องทาง',
    'about.feature.pdpa':'ฟอร์ม PDPA ครบถ้วน',
    'units.title':'คู่มือหน่วยพื้นที่',
    'units.th.rule':'หน่วยวัดที่ดินไทย',
    'units.rai':'1 ไร่ = 4 งาน = 400 ตร.วา',
    'units.ngan':'1 งาน = 100 ตร.วา',
    'units.wah':'1 ตร.วา = 4 ตร.ม.',
  ...
  en: {
    ...
    'about.feature.share':'Multi-channel sharing',
    'about.feature.pdpa':'Complete PDPA lead form',
    'units.title':'Land Unit Guide',
    'units.th.rule':'Thai land measurement',
    'units.rai':'1 Rai = 4 Ngan = 400 Sq.wah',
    'units.ngan':'1 Ngan = 100 Sq.wah',
    'units.wah':'1 Sq.wah = 4 Sq.m.',
  ...
  zh: {
    ...
    'about.feature.share':'多渠道分享',
    'about.feature.pdpa':'完整 PDPA 线索表单',
    'units.title':'土地单位指南',
    'units.th.rule':'泰国土地单位',
    'units.rai':'1莱 = 4岸 = 400平方哇',
    'units.ngan':'1岸 = 100平方哇',
    'units.wah':'1平方哇 = 4平方米',
    'units.convert':'换算',
