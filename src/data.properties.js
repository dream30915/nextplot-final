...
export let properties = [
  {
    ...
    location:{ th:'บางนา กรุงเทพมหานคร', en:'Bangna, Bangkok', zh:'曼谷 邦纳' },
    price:15000000,currency:'THB',areaRai:2.5,areaSqm:2.5*1600,status:'available',
    zoning:{ th:'สีเหลือง', en:'Yellow', zh:'黄色', color:'#FFD700',
      note:{ th:'ที่อยู่อาศัยหนาแน่นน้อย', en:'Low density residential', zh:'低密度住宅' } },
    tags:{ th:['ใกล้ถนนใหญ่','เหมาะลงทุน','โฉนดพร้อม'], en:['Near main road','Investment','Title deed'], zh:['临主路','投资','产权证'] },
    media:[
  ...
  },
  {
    ...
    price:5200000,currency:'THB',areaRai:3.5,areaSqm:3.5*1600,status:'available',
    zoning:{ th:'สีชมพู', en:'Pink', zh:'粉色', color:'#FFC0CB',
  ...
  },
  {
    ...
    price:7800000,currency:'THB',areaRai:2.0,areaSqm:2.0*1600,status:'available',
    zoning:{ th:'สีม่วงอ่อน', en:'Light Purple', zh:'淡紫色', color:'#B19CD9',
  ...
  },
  {
    ...
    location:{ th:'ปลวกแดง, ระยอง', en:'Pluak Daeng, Rayong', zh:'罗勇 Pluak Daeng' },
    price:3500000,currency:'THB',areaRai:1.25,areaSqm:1.25*1600,status:'reserved',
    zoning:{ th:'สีน้ำตาล', en:'Brown', zh:'棕色', color:'#8B4513',
    ...
    media:[ 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&auto=format&fit=crop&q=70' ]
  },
  {
    id:'NP004',code:'NP004',
    title:{ th:'ที่ดินวิวสวย เหมาะทำรีสอร์ท 5 ไร่', en:'Scenic Plot 5 Rai (Resort Potential)', zh:'景观地块 5 莱 适合度假村' },
    location:{ th:'ปลวกแดง, ระยอง', en:'Pluak Daeng, Rayong', zh:'罗勇 Pluak Daeng' },
    price:12500000,currency:'THB',areaRai:5.0,areaSqm:5.0*1600,status:'available',
    zoning:{ th:'สีเขียว', en:'Green', zh:'绿色', color:'#228B22',
    ...
    media:[ 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800&auto=format&fit=crop&q=70' ]
  },
  {
    id:'NP005',code:'NP005',
    title:{ th:'ที่ดินราคาพิเศษ 0.75 ไร่ (ขายแล้ว)', en:'Special Price 0.75 Rai (Sold)', zh:'特价 0.75 莱 (已售)' },
    location:{ th:'ปลวกแดง, ระยอง', en:'Pluak Daeng, Rayong', zh:'罗勇 Pluak Daeng' },
    price:2800000,currency:'THB',areaRai:0.75,areaSqm:0.75*1600,status:'sold',
    zoning:{ th:'สีเหลือง', en:'Yellow', zh:'黄色', color:'#FFD700',
      note:{ th:'ที่อยู่อาศัยหนาแน่นน้อย', en:'Low density residential', zh:'低密度住宅' } },
    tags:{ th:['ราคาพิเศษ'], en:['Special price'], zh:['特价'] },
    media:[ 'https://images.unsplash.com/photo-1523413651479-597eb2da0ad6?w=800&auto=format&fit=crop&q=70' ],
    is_sensitive:false
  }
]

// Runtime replace (ใช้ภายหลังตอนดึง remote)
export function replaceProperties(newList){
  if(Array.isArray(newList)&&newList.length){
    properties = newList
    console.log('[properties] replaced with remote list size =', newList.length)
  }
}
